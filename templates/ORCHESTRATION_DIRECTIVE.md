...
```json
{
  ...
  "action": "continue | close | pause | gap-fill | narrow-active-slice | blocked | recovery | remediate | red-team | evolution-loop | unstuck | abort | retry-once",
  "reason": "",
  "required_next_owner": "goal-loop | red-team | oracle-verification | active-slice | evolution-loop | unstuck | external-runner | user | none",
